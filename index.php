...
if (!($cates && is_array($cates))){
    alertMes("不好意思，暂时网站维护中！！！", "http://www.imooc.com");
}
...
<div class="shopList comWidth clearfix">
	...
	<div class="rightArea">
		...
		<div class="shopList_sm clearfix">
    		<?php
        		$prosSmall = getSmallProsById($cate['id']);
			...
			<div class="shopItem_sm">
				<div class="shopItem_smImg">
					<a href="proDetails.php?id=<?php echo $proSmall['id'];?>" target="_blank""><img height="95" width="95" src="image_220/<?php echo $proSmallImg['albumPath'];?>" alt=""></a>
				</div>
